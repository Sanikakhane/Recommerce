...
const ProductPage = () => {
  ...
  React.useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await fetch(`http://localhost:8000/api/v1/getproduct/${productname}`);
  ...
  return (
    <div className="container mx-auto p-4 bg-blue-300 w-[80vh] rounded-lg">
      <div className="flex flex-col items-center">
        <img src={product.link} alt={product.name} className="w-64 h-64 object-cover mb-4 rounded-lg" />
